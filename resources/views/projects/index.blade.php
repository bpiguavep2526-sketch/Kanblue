...
@section('navbar')
    ...
    <div class="d-flex align-items-center ms-auto">
        {{--  <span class="text-white small me-3"
            style="font-family: 'Poppins', sans-serif; font-weight: 300; font-size: 20px"> Usuario #{{ Auth::user()->name }}</span>
        <div class="iconoUsuario"> --}}
        {{-- <img src="{{ asset(auth()->user()->imagen ?? 'images/usuario.png') }}" alt="Icono Usuario" width="50" height="50"> --}}
    </div>
    </div>
...
@section('content')
    ...
    <div class="d-flex justify-content-between p-3 headerProyectos">
        {{-- <h1><img src="{{ asset('images/cortana.png') }}" alt="Volver" width="50" height="50"> Bienvenido
            Usuario#{{ Auth::user()->name }} , estos son sus proyectos actuales</h1>  --}}
                        ...
                        <div class="col-md-auto projectCard">
                            <div class="headerCard">
                                ...
                                <a href="{{ route('tasks.edit') }}">
                                    <img src="{{ asset('images/botonEditar.png') }}" alt="Editar" class="imgEditar">
                                </a>
                            </div>
                            <hr class="hrCard">
                            <ul>
                            ...
                            <div class="footerCard">
                                <a href="{{ route('tasks.taskscreen') }}" class="btnstylenewproject btnOg"><strong>ABRIR PROYECTO</strong></a>
                            </div>
                ...
                <div class="col-md-auto cardUltima">
                    ...
                    <div class="col-md-auto cardSegunda">
                        ...
                        <div class="col-md-auto projectCard">
                            <div class="headerCard">
                                <h3>PROYECTO #42378</h3>
                                <a href=""><img src="{{ asset('images/botonEditar.png') }}" alt="Editar"
                                        class="imgEditar"></a>
                            </div>
                            <hr class="hrCard">
                            <ul>
